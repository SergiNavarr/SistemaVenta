...
namespace SistemaVenta.AplicacionWeb.Controllers
{
    public class CategoriaController : Controller
    {
        ...
        public async Task<IActionResult> Lista()
        {
            ...
            // Retorna una respuesta HTTP 200 con la lista de categorías mapeadas
            // Se envuelve el resultado en un objeto anónimo con la propiedad "data" para trabajar con DataTables
